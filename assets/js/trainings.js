      ...
      init=[
        {
          ...
          'difficulty':'60',
          'banner':'cardio3.jpg',
          'description':'Spinn - Sinonim za cardio je SPINNING trening, intenzivna vožnja statičnih bicikala sa opterećenjem uz ritmove muzike. '
        },{
          ...
          'difficulty':'40',
          'banner':'pilates2.jpg',
          'description':'STOTT PILATES je izuzetno specifičan i sofisticiran način vežbanja pilatesa na originalnim terapeutskim spravama reformerima'
        },{
          ...
          'difficulty':'60',
          'banner':'pilates3.jpg',
          'description':'Reformer se sastoji od pokretne platforme koja klizi napred i nazad na klizačima i koristi opruge kao otpore.'
        }
      ];
 ...
 /*--------------------------------------------------------------
  ...
  $(document).on('click', '.comment-reply', function(e) {
    ...
    <span class="commenter-name">\
      ...
      <button type="cancel" class="btn btn-default cancel">Otkazi</button>\
    </span>\
  </div>';
...
function appendComment(appendTo,name,content,likes,dislikes,replied,id){
  ...
  <div class="comment-box add-comment reply-box">\
    ...
    <span class="commenter-name">\
      ...
      <button type="cancel" class="btn btn-default reply-popup">Otkazi</button>\
    </span>\
  </div></div>');
...
function storeNewComment(arr,name,content){
  ...
  $('.total-comments').text(parseInt($('.total-comments').text())+1+" komentara");
}
var commentArray;
var title;
